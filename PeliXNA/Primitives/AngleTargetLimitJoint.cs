...
namespace Net.Brotherus
{
    public class AngleTargetLimitJoint
    {
        ...
        public float TargetAngleDegrees { set { TargetAngleRadians = value.ToRadians(); } }
    }
}
